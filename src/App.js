...
//                     name="Aadhar-card"
//                   >
//                     <Input placeholder="Enter Aadhaar card no. (1111 2222 3333)" />
//                   </Form.Item>
//                 </Col>
//                 <Col span={8}>
//                   <Form.Item
//                     label={<CustomLabel label="Mobile Number" />}
//                     name="mobile-number"
//                     rules={[
//                       {
//                         required: true,
                          ...
                          <Select.Option key={index} value={item.name}>
                            <Checkbox
                              ...
                              onChange={(e) => {
                                ...
                                const nextSelectedLocations = checked
                                  ? [...selectedLocations, item.name]
